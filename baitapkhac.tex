...
\begin{itemize}
    ...
    \item Professor Antti Laaksonen for introducing me to graph theory.
    \item 3Blue1Brown.
    \item David Cabatingan's team for the notes on \hyperref[thr:kuratowski]{Kuratowski's theorem}
