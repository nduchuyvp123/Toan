...
\begin{itemize}
    \item My mentor, Nguyen Hai Vinh, for his guidance.
    \item \href{https://cses.fi/book/book.pdf}{Professor Antti Laaksonen} for introducing me to graph theory.
    \item \href{https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw}{3Blue1Brown} for \href{https://github.com/dcabatin/manim}{manim} Python library.
    \item \href{https://www.youtube.com/watch?v=DOnY6eZi2E8}{David Cabatingan's team} for the notes on \hyperref[thr:kuratowski]{Kuratowski's theorem}
    \item Professor "" for organizing the HUS.
\end{itemize}
\end{document}